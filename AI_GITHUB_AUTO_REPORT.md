...
?? email_notifier.py.backup_debug_20250531_015038
?? email_notifier.py.backup_env_fix_20250531_015733
?? email_notifier.py.backup_env_fix_20250531_015914
?? monitoring_logs/backup_20250531_000804_email_notifier.py
?? monitoring_logs/backup_20250531_000804_lvyuan_collector.py
?? monitoring_logs/backup_20250531_000804_main.py
?? monitoring_logs/backup_20250531_011350_email_notifier.py
?? monitoring_logs/backup_20250531_011350_lvyuan_collector.py
?? monitoring_logs/backup_20250531_011350_main.py
?? monitoring_logs/backup_20250531_015921_email_notifier.py
?? monitoring_logs/backup_20250531_020425_email_notifier.py
?? monitoring_logs/backup_20250531_021432_email_notifier.py
?? scripts/ai_development_assistant.sh.backup_v3.2_20250530_231228
?? scripts/ai_development_assistant.sh.backup_v3.2_20250530_231448
?? scripts/ai_development_assistant.sh.backup_v3.3_20250530_234250
?? scripts/ai_development_assistant.sh.backup_v3.4.1_20250531_011146
?? scripts/ai_development_assistant.sh.backup_v3.4_20250531_001127
?? scripts/ai_development_assistant.sh.backup_v3.4_20250531_001243
?? scripts/ai_development_assistant.sh.backup_v3.4_debug_20250531_004913
?? scripts/ai_development_assistant.sh.backup_v3.4_debug_20250531_005034
?? settings_manager.py.backup_20250531_083224
?? system_backups/backup_20250531_092510/
```

### 📝 最近のコミット履歴（5件）
```
6096424 🎉 fix(email): メール送信機能の完全復旧 (v3.5)
f4894a2 🎉 feat(v3.4.1): AST修正機能堅牢化と初の完全自律修正サイクル成功
a7be83a 🚀 feat(v3.3): GitHub変更をトリガーとした自動分析機能を追加
186355a test: Trigger auto-analysis workflow
8e1e179 Merge branch 'main' of github.com:fffken/hanazono-system
```
...
**logs/collector_20250531.log:**
```
2025-05-31 09:15:03,299 - lvyuan_collector - INFO - インバーターのIPアドレスを検索中...
2025-05-31 09:15:03,425 - lvyuan_collector - INFO - 現在のIPアドレス (192.168.0.202) に接続できます
2025-05-31 09:15:04,366 - lvyuan_collector - INFO - データ収集成功: 5パラメーター, インバーターIP: 192.168.0.202
```
...
**./solar_control.log:**
```
2025-05-31 09:25:11,508 - INFO - スケジューラ: 現在時刻 2025-05-31 09:25:11
2025-05-31 09:26:11,509 - INFO - スケジューラ: 現在時刻 2025-05-31 09:26:11
2025-05-31 09:27:11,510 - INFO - スケジューラ: 現在時刻 2025-05-31 09:27:11
```
...
```
�K�K�%�&�&�&�&�&r   )	r
   �logging.handlersr   �datetime�configr   r   r   r-   � r   r   �<module>r2      sp   �� ���� 0� 0� 0� 0� 0� 0� ���� � � � � � �� � � 
�����'� '� '� '� 'r   ```
...
#### 🐍 Python関連プロセス
```
pi           462  0.0  1.3  19192  5572 ?        Ss   May06   0:54 python /home/pi/lvyuan_solar_control/solar_control_scheduler.py
```

#### 💾 システムリソース状況
```
=== CPU・メモリ使用状況 ===
top - 09:27:49 up 24 days, 11:57,  1 user,  load average: 0.10, 0.07, 0.02
Tasks: 148 total,   1 running, 147 sleeping,   0 stopped,   0 zombie
%Cpu(s):  0.0 us, 25.0 sy,  0.0 ni, 75.0 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st 
MiB Mem :    416.8 total,    141.6 free,    186.8 used,    150.6 buff/cache     
MiB Swap:    512.0 total,    456.9 free,     55.1 used.    230.0 avail Mem 

=== ディスク使用状況 ===
Filesystem      Size  Used Avail Use% Mounted on
udev             75M     0   75M   0% /dev
tmpfs            42M  960K   41M   3% /run
/dev/mmcblk0p2   57G  4.1G   50G   8% /
...
Hostname: solarpi
Uptime:  09:27:56 up 24 days, 11:57,  1 user,  load average: 0.17, 0.08, 0.02
Current user: pi
Working directory: /home/pi/lvyuan_solar_control

=== メモリ使用状況詳細 ===
               total        used        free      shared  buff/cache   available
Mem:           416Mi       184Mi       143Mi       8.0Ki       150Mi       231Mi
...
**最終更新**: 2025-05-31 09:25:10
**セッションID**: 20250531_092510
**緊急度レベル**: 通常

## 🤖 AI自動分析結果
- **現在のフェーズ**: 大規模開発中（未コミット: 26件）- 要整理
...
### 📄 HANDOVER_PROMPT.md
```markdown
# v6_HANAZONOシステム／完全自動記憶継承プロンプト-2025-05-31

**自動生成**: 2025-05-31 09:25:10
**セッションID**: 20250531_092510
**緊急度**: 通常
...
```markdown
# AI自動作業指示書 - セッション20250531_092510

**生成時刻**: 2025-05-31 09:25:10
**緊急度**: 通常
...
### システム自動確認項目
1. **Git状態確認**: 26 files changed
2. **最新コミット**: 6096424 🎉 fix(email): メール送信機能の完全復旧 (v3.5)
3. **フェーズ判定**: 大規模開発中（未コミット: 26件）- 要整理
