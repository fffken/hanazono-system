...
## 🚨 最重要3項目
1. {critical_3[0]['description'] if len(critical_3) > 0 else 'データなし'}
2. {critical_3[1]['description'] if len(critical_3) > 1 else 'データなし'}
3. {critical_3[2]['description'] if len(critical_3) > 2 else 'データなし'}
